...
public class DatabaseConfig {
    ...
    public static void testConnection() {
        try (Connection connection = DriverManager.getConnection(url, user, password)) {
            ...
            statement.executeUpdate("CREATE TABLE IF NOT EXISTS books (id BIGINT PRIMARY KEY AUTO_INCREMENT, name VARCHAR(100) NOT NULL, author VARCHAR(100) NOT NULL, page_number INT NOT NULL, user_id BIGINT NOT NULL)");
